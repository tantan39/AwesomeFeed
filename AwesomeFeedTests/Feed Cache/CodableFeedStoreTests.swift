...
class CodableFeedStoreTests: XCTestCase {
    ...
    func test_insert_overridesPreviouslyInsertedCacheValues() {
        ...
        XCTAssertNil(latestInsertionError, "Expected override cache successfully")
    ...
    private func expect(_ sut: FeedStore, toRetrieve expectedResult: RetrieveCachedFeedResult, file: StaticString = #filePath, line: UInt = #line) {
        ...
        sut.retrieve { retrievedResult in
            ...
            default:
                XCTFail("Expected to retrieve, got \(expectedResult) and \(retrievedResult) instead", file: file, line: line)
            }
            exp.fulfill()
        }
